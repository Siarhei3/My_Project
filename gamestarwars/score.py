...
class Scores(): # вывод игрового счета
    ...
    def image_score(self): # приобразовывает текс счета в графическое изображение
        self.score_img = self.font.render(str(self.stats.score), True, self.text_color, (0, 0, 0))
        self.score_rect = self.score_img.get_rect()
        self.score_rect.right = self.screen_rect.right - 40
        self.score_rect.top = 20

    def image_hight_score(self): # рекорд
        ...
        self.hight_score_rect.top = self.score_rect.top + 20
    ...
    def show_score(self): # вывод счет на экран
